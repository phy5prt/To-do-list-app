# To-do-list-app
Node.js EJS app allowing the creation of todo lists to custom routes based on title. Items and titles are saved.

To Do List WebApp: The app has header, footer, about and list partial templates. 
You can create a new list by typing a new list title into the route. 
The route, title and items are saved to a database.

Use the Webapp:  https://boiling-gorge-57031.herokuapp.com/
